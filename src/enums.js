export const PAGES_NAMES = {
	...
	QUESTION_PAGE_PROFILE_EDIT_VIEW: 'QUESTION_PAGE_PROFILE_EDIT_VIEW',
...
export const FEEDBACK_QUESTIONS_TYPE = {
	RATING: 1,
	TEXT: 2
}

export const MIN_RATING_FEEDBACK_VALUE = 1
export const MAX_RATING_FEEDBACK_VALUE = 5
export const SINGLE_FEEDBACK_TEXT_MESSAGE_CHAR_LIMIT = 9999
